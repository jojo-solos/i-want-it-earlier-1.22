...
public class CreakingEntity extends HostileEntity {
    ...
    public SoundEvent getAmbientSound() {
        return ModSounds.ENTITY_CREAKING_AMBIENT;
    }

    @Override
    public SoundEvent getHurtSound(DamageSource source) {
        return ModSounds.ENTITY_CREAKING_TWITCH;
    }

    @Override
    public SoundEvent getDeathSound() {
        return ModSounds.ENTITY_CREAKING_DEATH;
    }

    @Override
    public void playAttackSound() {
        this.playSound(ModSounds.ENTITY_CREAKING_ATTACK);
    }

    @Override
    public void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(ModSounds.ENTITY_CREAKING_STEP, 0.15F, 1.0F);
    }
}